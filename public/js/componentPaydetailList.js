Vue.component('component-pay-detail-list', {
  ...
  template: `<div>
              ...
              <div @click="onClick(d)" v-for="(d,i) in config.list" :key='i'  class="flex content-between pay-detail-list-item bottom-line">
                ...
                <div  style="width: 60%;" class="flex-column content-center">
                    ...
                    <van-progress color="#FF9966" track-color="#99CC99" :percentage="d.m/config.sum*100" :show-pivot="false" />
